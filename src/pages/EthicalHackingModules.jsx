...
import modulesData from "../data/ethical-hacking/modules.json";

const EthicalHackingModules = () => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 py-12 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          <Link
            to="/"
            className="text-green-700 hover:text-green-800 font-medium mb-4 inline-block"
          >
            ← Back to Courses
          </Link>
              ...
              >
                ...
                <div className="p-4 flex flex-col flex-grow">
                  ...
                  <div className="space-y-2 mt-auto">
                    {module.hasSummary ? (
                      <Link
                        to={`/ethical-hacking/${module.id}/summary`}
                    ...
                    {module.hasQuiz ? (
                      <Link
                        to={`/ethical-hacking/${module.id}/quiz`}
                        className="block w-full bg-green-700 text-white text-center py-2 rounded-lg font-semibold hover:bg-green-800 transition-colors text-sm"
                      >
                        📊 Take Quiz
                      </Link>
                    ) : null}
